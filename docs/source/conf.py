...
extlinks = {
    'issue': ('https://github.com/NCAR/esmlab-regrid/issues/%s', 'GH#'),
    'pr': ('https://github.com/NCAR/esmlab-regrid/pull/%s', 'GH#'),
}
...
htmlhelp_basename = 'esmlab_regriddoc'
...
latex_documents = [
    (master_doc, 'esmlab_regrid.tex', u'esmlab-regrid Documentation', author, 'manual')
]
...
man_pages = [(master_doc, 'esmlab_regrid', u'esmlab-regrid Documentation', [author], 1)]
